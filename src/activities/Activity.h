...
class Activity {
 ...
 public:
  ...
  // E-paper retains its pixels without power. Activities such as the image
  // viewer can request sleep without replacing the current frame.
  virtual bool preserveScreenOnSleep() const { return false; }
