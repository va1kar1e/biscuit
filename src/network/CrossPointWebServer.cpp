...
void CrossPointWebServer::begin() {
  ...
  WiFi.setSleep(false);
  // The file-transfer activity tolerates brief link loss while the WiFi driver
  // reconnects. Explicitly enable it because the framework default can vary.
    ...
    if (packetSize > 0) {
      ...
      if (len > 0) {
        ...
        if (strcmp(buffer, "hello") == 0) {
          ...
          String message = "biscuit (on " + hostname + ");" + String(wsPort);
