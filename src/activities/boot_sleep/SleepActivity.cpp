...
void SleepActivity::renderCustomSleepScreen() const {
  // A wallpaper explicitly selected in Image Viewer takes precedence over the
  // optional random-image directories.
  FsFile wallpaper;
  if (Storage.openFileForRead("SLP", "/sleep.bmp", wallpaper)) {
    Bitmap bitmap(wallpaper, true);
    if (bitmap.parseHeaders() == BmpReaderError::Ok) {
      LOG_DBG("SLP", "Loading selected wallpaper: /sleep.bmp");
